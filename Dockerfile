...
COPY . /home/jh/data
RUN echo "alias uml='bash jhuml_retrieve_java_entity_files.sh'" >> /home/jh/.bashrc
...
ENV PATH $PATH:/usr/bin:/home/jh/data/bin:/home/jh/.bashrc:/usr/local/share/.config/yarn/global/node_modules/.bin
